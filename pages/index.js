            ...
            <div className="right-inner" id="right-scroll" ref={rightScrollRef} style={{opacity:sectionVisible?1:0,transition:'opacity .35s ease'}}>
              ...
              <div className={`content-section${current==='portfolio'?' active':''}`}>
                ...
                {[
                  ...
                  {num:'§ V',  tag:'Business Development',  title:'Partner Network Expansion',    desc:'Built and maintained strategic relationships with sales partners, expanding market reach and increasing revenue streams across regions through effective networking.',      tech:['Partnership','Networking','Growth'],             links:[],onGallery:true,galleryImgs:['https://res.cloudinary.com/dyhvx9wit/image/upload/v1772685901/20190804_100850_m6xls6.jpg','https://res.cloudinary.com/dyhvx9wit/image/upload/v1772685891/IMG_20190920_193619_pwc6au.jpg','https://res.cloudinary.com/dyhvx9wit/image/upload/v1772685896/IMG20190806091605_ssinhd.jpg'],galleryTitle:'Partner Network'},
                ].map(item => (
